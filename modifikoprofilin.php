...
<main class="container page">
    ...
    <section id="content" class="box">
        <?php
        if (isset($_GET['profiliid'])) {
            $antari=merrAnetarId($_GET['profiliid']);
        ...
        if (isset($_POST['ruaj'])) {
            ...
            modifikoProfil($_POST['antariid'],$_POST['emri'], $_POST['mbiemri'], $_POST['telefoni'], 
            $_POST['email'], $_POST['fjalekalimi']);
        }

        ?>
        <form id="anetari" method="POST">
            <legend>Forma për modifikimin e profilit</legend>
